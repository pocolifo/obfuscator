package com.pocolifo.obfuscator.engine.passes.string;
...
public class StringManglerPass extends AbstractMethodPass<StringManglerOptions> implements Opcodes {
    ...
    @Override
    public void doMethod(ObfuscatorEngine engine, Collection<ClassNode> inClasses, ClassNode classNode, MethodNode methodNode, ProgressBar bar, StringManglerOptions options) {
    ...
    private InsnList expandString(String obfString, MethodNode methodNode) {
        // todo encrypt obfString, then at usage, afterResourcesAndClasses decrypt method
